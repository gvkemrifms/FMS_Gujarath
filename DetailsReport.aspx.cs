...
public partial class DetailsReport : Page
{
    ...
    public void Loaddata()
    {
        try
        {
            AccidentReport.FillDropDownHelperMethodWithSp("P_FMS_Report_VehicleDetails_FitnessReneweal", null, null, ddldistrict, ddlvehicle, txtfrmDate, txttodate, "@DistrictID", "@VehicleID", "@From", "@To", null, Grddetails);
        }
        catch (Exception)
        {
            // ignored
