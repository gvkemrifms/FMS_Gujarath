...
public partial class SparePartsMaster : Page
{
    ...
    protected void gvSpareParts_RowEditing(object sender, GridViewEditEventArgs e)
    {
        ...
        var ds = _objFleetMaster.IEditSpareParts(spId);
    ...
    protected void gvSpareParts_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        hidSpareId.Value = lblId.Text;
        int spId = Convert.ToInt16(hidSpareId.Value);
        var result = _objFleetMaster.IDeleteSpareParts(spId);
    ...
    {
        var res = _objFleetMaster.IUpdateSpareParts(sparePartId, spareName, manufacturerSpareId, manufacturerId, sparePartGroupId, groupName, cost);
        switch (res)
        {
            case 1:
    ...
    {
        var res = _objFleetMaster.IInsertSpareParts(spareName, manufacturerSpareId, manufacturerId, sparePartGroupId, groupName, cost);
        switch (res)
        {
            case 1:
