...
{
    public IFleetMaster ObjTyresDetails = new FMSFleetMaster();
        ...
        switch (btnTyresDetailsSave.Text)
        {
            case "Save":
            {
                ...
                else
                {
                    ...
                    ds = ObjTyresDetails.InsertTyresDetails(tyreItemCode, tyreNumber, make, model, size, tStatus, tInactdate, tCreatedate, tCreateby, tUpdatedate, tUpdateby);
            ...
            default:
            {
                ...
                else
                {
                    ...
                    var model = txtTyreModel.Text;
                    var size = txtTyreSize.Text;
                    ds = ObjTyresDetails.UpdateTyresDetails(tyreId, tyreItemCode, tyreNumber, make, model, size);
                    switch (ds.Tables.Count)
                    {
                        case 0:
