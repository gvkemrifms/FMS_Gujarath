...
public partial class VehicleCardTypeReport : Page
{
    ...
    protected void GetVehicleCardTypeReport()
    {
        ...
        var vehicleCardTypeReport = reportpath + "FMSReport_GetCardType&rs%3aCommand=Render&rc:Parameters=false&rc:Toolbar=false&DistrictID=" + _vehreg.DistrictId + "&BunkID=" + Convert.ToInt16(ddlSSN.SelectedItem.Value);
    ...
    {
        var reportpath = ConfigurationManager.AppSettings["reportServerPath"] + "?%2f" + ConfigurationManager.AppSettings["reportFolderPath"] + "%2f";
        var vehicleCardTypeReport = reportpath + "FMSReport_GetCardType&rs%3aCommand=Render&rc:Parameters=false&rs:Format=EXCEL&DistrictID=" + Convert.ToInt16(ddlDistrict.SelectedItem.Value) + "&BunkID=" + Convert.ToInt16(ddlSSN.SelectedItem.Value);
    ...
    protected void ddlDistrict_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            var ds = _vehreg.GetServiceStn(districtIdssn);
            if (ds != null)
            {
