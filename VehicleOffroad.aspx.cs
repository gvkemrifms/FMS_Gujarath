...
namespace GvkFMSAPP.PL.VAS
{
    ...
    {
        private readonly BLL.BaseVehicleDetails _fmsobj = new BLL.BaseVehicleDetails();
        ...
        public void FillMaintenanceTypes()
        {
            ...
            if (dset == null) return;
            AccidentReport.FillDropDownHelperMethodWithDataSet(dset, "Maint_Type_ID", "Maint_Desc", ddlreasons);
        ...
        public void SendSms(string vehicleno, string breakdownid, string reason)
        {
            ...
            try
            {
                ...
                AccidentReport.ExecuteSelectStmt(query);
            }
            catch (Exception)
            {
                // ignored
        ...
        protected void ddlDistrict_SelectedIndexChanged(object sender, EventArgs e)
        {
            switch (ddlDistrict.SelectedIndex)
            {
                ...
                default:
                    ...
                    AccidentReport.FillDropDownHelperMethodWithDataSet(ds, "Vehicle", "VehicleNumber", null, ddlVehicleNumber);
        ...
        public void GetAggregates()
        {
            ...
            AccidentReport.FillDropDownHelperMethodWithDataSet(ds, "Aggregate_Id", "Aggregates", ddlAggregates);
        }
        ...
        public void GetCategories()
        {
            ...
            AccidentReport.FillDropDownHelperMethodWithDataSet(ds, "Category_Id", "Categories", ddlCategories);
        }
        ...
        public void GetSubCategories()
        {
            ...
            AccidentReport.FillDropDownHelperMethodWithDataSet(ds, "SubCategory_Id", "SubCategories", ddlSubCategories);
        }
